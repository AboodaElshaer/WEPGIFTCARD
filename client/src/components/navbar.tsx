    ...
    <nav className="fixed top-0 left-0 right-0 z-50 px-4 py-4 md:px-8">
      <div className="max-w-7xl mx-auto glass-panel rounded-2xl flex items-center justify-between px-6 py-3 border-white/5 bg-background/40 backdrop-blur-xl">
        ...
        <div className="hidden md:flex items-center gap-8 text-sm font-medium">
          <Link href="/games"><span className="text-white hover:text-primary transition-colors neon-text-hover cursor-pointer">Games</span></Link>
          <Link href="/games"><span className="text-muted-foreground hover:text-primary transition-colors cursor-pointer">Gift Cards</span></Link>
          <Link href="/games"><span className="text-muted-foreground hover:text-primary transition-colors cursor-pointer">Trending</span></Link>
          <Link href="/games"><span className="text-muted-foreground hover:text-primary transition-colors cursor-pointer">Support</span></Link>
        </div>
