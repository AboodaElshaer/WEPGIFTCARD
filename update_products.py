...
with open('client/src/lib/products.json', 'r', encoding='utf-8') as f:
...
for p in products:
    p['packages'] = packages_map.get(p['id'], [])

with open('client/src/lib/products.json', 'w', encoding='utf-8') as f:
